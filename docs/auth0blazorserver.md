...
> The Auth0 Blazor Server template has been discontinued, as is the corresponding builtin template (`blazorserver`) (see [here](https://learn.microsoft.com/en-us/dotnet/core/tools/dotnet-new)).
